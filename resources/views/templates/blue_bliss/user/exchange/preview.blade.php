                        ...
                        <div class="card custom--card">
                            ...
                            <div class="card-body p-0">
                                <ul class="list-group list-group-flush p-3">
                                    <li
                                        class="list-group-item d-flex justify-content-between flex-column flex-wrap border-dotted">
                                    ...
                                    <li
                                        class="list-group-item d-flex justify-content-between flex-column flex-wrap border-dotted">
                                        <span class="fw-bold">
                                            {{ showAmount(@$exchange->sending_amount) }}
                                    ...
                                    <li
                                        ...
                                        <span class="fw-bold text--danger">
                                            {{ showAmount(@$exchange->sending_charge) }}
                                            {{ __(ucfirst(@$exchange->sendCurrency->cur_sym)) }}
                                        </span>
                            ...
                            <div class="card-body p-0">
                                <ul class="list-group list-group-flush p-3">
                                    ...
                                    <li
                                        class="list-group-item d-flex justify-content-between flex-column flex-wrap border-dotted">
                                        <span class="fw-bold">
                                            {{ showAmount(@$exchange->receiving_amount) }}
                                            {{ __(ucfirst(@$exchange->receivedCurrency->cur_sym)) }}
                                        </span>
                                    ...
                                    <li
                                        class="list-group-item d-flex justify-content-between flex-column flex-wrap border-dotted">
                                        <span class="fw-bold text--danger">
                                            {{ showAmount(@$exchange->receiving_charge) }}
                                            {{ __(ucfirst(@$exchange->receivedCurrency->cur_sym)) }}
                                        </span>
                                        <small class="text-muted">@lang('Charge')</small>
                                    </li>
                                ...
                                <form method="post" action="{{ route('user.exchange.confirm') }}"
                                    ...
                                    <div class="form-group">
                                        <label class="form-label required"
                                            for="paytm_wallet">{{ __(@$exchange->receivedCurrency->name) }}
