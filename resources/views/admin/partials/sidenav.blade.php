        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item  {{ menuActive('admin.currency.*') }}">
                    <a href="{{ route('admin.currency.index') }}" class="nav-link" data-default-url="{{ route('admin.currency.index') }}">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.exchange*', 2) }} ">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive('admin.exchange.list', null, 'pending') }} ">
                                <a href="{{ route('admin.exchange.list', 'pending') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending Exchange')</span>
                                    @if ($pendingExchange)
                                        <span class="menu-badge pill bg--danger ms-auto">{{ $pendingExchange }}</span>
                                    @endif
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.exchange.list', null, 'canceled') }} ">
                                <a href="{{ route('admin.exchange.list', 'canceled') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Canceled Exchange')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.exchange.list', null, 'refunded') }} ">
                                <a href="{{ route('admin.exchange.list', 'refunded') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Refunded Exchange')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.exchange.list', null, 'approved') }} ">
                                <a href="{{ route('admin.exchange.list', 'approved') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Approved Exchange')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.exchange.list', null, 'list') }} ">
                                <a href="{{ route('admin.exchange.list', 'list') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                        ...
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive(['admin.report.referral.commission']) }}">
                                <a href="{{ route('admin.report.referral.commission') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Referall Commissions')</span>
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item  {{ menuActive('admin.referral') }}">
                    <a href="{{ route('admin.referral') }}" class="nav-link" data-default-url="{{ route('admin.referral') }}">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.blocked.ip') }}">
                    <a href="{{ route('admin.blocked.ip') }}" class="nav-link">
                        <i class="menu-icon las la-map-marked"></i>
                        <span class="menu-title">@lang('IP Blocking')</span>
                    </a>
                </li>
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.setting.notification*', 2) }} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.setting.notification.sms') }} ">
                              ...
                              <li class="sidebar-menu-item {{ menuActive('admin.setting.notification.push.setting') }} ">
                                <a href="{{ route('admin.setting.notification.push.setting') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
